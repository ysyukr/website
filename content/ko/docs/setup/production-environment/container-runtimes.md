...
1. 각 노드에서 [도커 엔진 설치](https://docs.docker.com/engine/install/#server)에 따라 리눅스 배포판용 도커를 설치한다. 이 [종속성](https://git.k8s.io/kubernetes/build/dependencies.yaml) 파일에서 검증된 최신 버전의 도커를 찾을 수 있다.
