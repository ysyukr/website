...
- [리눅스에 kubectl 설치](#리눅스에-kubectl-설치)
  ...
  - [Google Cloud SDK를 사용하여 설치 {#install-on-linux-as-part-of-the-google-cloud-sdk}](#google-cloud-sdk를-사용하여-설치-install-on-linux-as-part-of-the-google-cloud-sdk)
...
1. `apt` 패키지 색인을 업데이트하고 쿠버네티스 `apt` 리포지터리를 사용하는데 필요한 패키지들을 설치한다.
